my_data_or=read.csv("C:/Users/venuk/OneDrive/Desktop/projects/Project 2_Logistic_R (1)/bankloan.csv")
dim(my_data_or)


table(my_data_or$default)
my_data_or$default=as.factor(my_data_or$default)
#0   1 
#517 183 
...
train_data1=my_data[sample_data==1,]
dim(train_data1) #733   9
test_data1=my_data[sample_data==2,]
